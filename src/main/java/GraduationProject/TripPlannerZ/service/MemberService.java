...
public class MemberService {
    ...
    // 여행 일정 검색
    public Page<MemberTrip> findTrip(String email, String sortType, Pageable pageable, String keyWord) {
        return memberRepository.tripList(email, sortType, pageable, keyWord);
    }
