...
// 가짜 응답 데이터를 정의합니다.
const successResponse = { status: 200, message: 'Login successful', data: { username: 'aaa', role: 'user' } };
const errorResponse = { status: 401, message: 'Login failed. Invalid credentials.', data: null };
