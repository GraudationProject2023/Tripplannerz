  ...
  return (
    <div className="StartPage">
      ...
      <div className="show">
        ...
        <Button variant="primary" onClick={handleFirstShow} style={{ marginLeft: "120px", marginTop: "40px", backgroundColor: "#FFFFFF", color: "#000000", width: "150px", height: "37px" }}>
          로그인
        </Button>
        <Modal style={{ width: "600px", height: "600px" }} show={firstShowModal} onHide={handleFirstClose}>
        ...
        <Button variant="primary" onClick={handleShow} style={{ marginLeft: "10px", marginTop: "40px", backgroundColor: "#FFFFFF", color: "#000000", width: "150px", height: "37px" }}>
          회원가입
        </Button>

        <Modal style={{ width: "600px", height: "700px" }} show={showModal} onHide={handleClose}>
          <Modal.Header closeButton>
          ...
          <Modal.Body>
            ...
            {nestedModal && (<Modal style={{ width: "600px", height: "700px" }} show={handleNestedModal} onHide={handleCloseNested}>
              <Modal.Header closeButton>
